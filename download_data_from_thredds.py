...
Script para baixar dados de servidor de dados Thredds 
(https://www.unidata.ucar.edu/about), através do serviço OPeNDAP,
usando biblioteca xarray no Python
"""
...
if __name__ == '__main__':
    ...
    # Se não passar uma pasta, cria uma baseada nas coordenadas
    if not folder:
    ...
    for year in years:
        ...
        # Período inicial e final de cada respectivo ano
        start_ = (
